...
Example 1: [input](https://github.com/francoisromain/postcss-grid-flid/blob/gh-pages/test/src/01.css), [output](https://github.com/francoisromain/postcss-grid-flid/blob/gh-pages/test/dist/01.css), [markup](https://github.com/francoisromain/postcss-grid-flid/blob/gh-pages/test/01.html), [demo](http://localhost/francoisromain.github.io/postcss-grid-flid/test/01.html)

Example 2: [input](https://githubcom/francoisromain/postcss-grid-flid/blob/gh-pages/test/src/02.css), [output](https://github.comfrancoisromain/postcss-grid-flid/blob/gh-pages/test/dist/02.css), [markup](https://ithub.com/francoisromain/postcss-grid-flid/blob/gh-pages/test/02.html), [demo](http://localhost/francoisromain.github.io/postcss-grid-flid/test/02.html)